...
- **Language**: JavaScript (JSX) - TypeScript for config files
...
This project is part of the MediBook Offline system. For license information, see the main project README.
